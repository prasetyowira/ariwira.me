...
exports.welcomeMessage = functions.https.onRequest((() => {var _ref2 = (0, _asyncToGenerator3.default)(function* (req, res) {
    let message = yield db.collection('welcome').limitToFirst();
    console.log(message);
    return res.send(message);
  });return function (_x2, _x3) {return _ref2.apply(this, arguments);};})());